<?php include_once 'header.php'; ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="morning-user">
                                <h2>Good Morning, <span><?php echo $_SESSION['user_name']; ?></span></h2>
    ...
    <script src="assets/js/jquery-3.7.1.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/feather.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/jquery.slimscroll.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/select2.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/plugins/datatables/jquery.dataTables.min.js"
        type="617df328242d590dc13537b5-text/javascript"></script>
    <script src="assets/plugins/datatables/datatables.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/jquery.waypoints.js" type="617df328242d590dc13537b5-text/javascript"></script>
    <script src="assets/js/jquery.counterup.min.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/plugins/apexchart/apexcharts.min.js" type="617df328242d590dc13537b5-text/javascript"></script>
    <script src="assets/plugins/apexchart/chart-data.js" type="617df328242d590dc13537b5-text/javascript"></script>

    <script src="assets/js/app.js" type="617df328242d590dc13537b5-text/javascript"></script>
    <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="617df328242d590dc13537b5-|49" defer></script>
</body>

<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Aug 2024 07:43:40 GMT -->
