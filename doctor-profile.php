<?php include_once 'header.php'; ?>
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content-set">
                                                <ul class="nav">
                                                    ...
                                                    <li>
                                                        <a href="doctor-setting.html"><span
                                                                class="set-about-icon me-2"><img
                                                    ...
                                                    <div class="col-xl-3 col-md-6">
                                                        <div class="detail-personal">
                                                            ...
                                                            <h3><a href="https://preclinic.dreamstechnologies.com/cdn-cgi/l/email-protection"
                                                                    class="__cf_email__"
                                                                    data-cfemail="7a18080f191f3a1f171b131654191517">[email&#160;protected]</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3 col-md-6">
                                                    ...
                                                    <table class="table mb-0 border-0 custom-table profile-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button
                                                                        class="custom-badge status-orange ">Good</button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>2005-2014</td>
    ...
    <script src="assets/js/jquery-3.7.1.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/js/feather.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/js/jquery.slimscroll.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/js/select2.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/plugins/moment/moment.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>

    <script src="assets/js/app.js" type="1d809b64e6bd3c8b87b7cb85-text/javascript"></script>
    <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="1d809b64e6bd3c8b87b7cb85-|49" defer></script>
</body>

<!-- Mirrored from preclinic.dreamstechnologies.com/html/template/doctor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Aug 2024 07:44:11 GMT -->
